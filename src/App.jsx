      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          <Route element={<MainLayout />}>
            ...
            <Route path={ROUTE_PATHS.ABOUT_TRUST} element={<ComingSoon title="About Trust" />} />
            <Route path={ROUTE_PATHS.ABOUT_TEMPLE} element={<ComingSoon title="About Temple" />} />
            <Route path={ROUTE_PATHS.ONLINE_DARSHAN} element={<ComingSoon title="Online Darshan" />} />
            ...
            <Route path={ROUTE_PATHS.MEMBERSHIP_REGISTER} element={<Register />} />
            <Route
