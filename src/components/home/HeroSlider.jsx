...
const slides = [
  { image: heroOne, eyebrow: "Welcome to", title: "Shree Sidhh Rudreshwar Seva Santha & Charitable Trust", sub: "A sanctuary of devotion, service and community — open to every soul seeking Mahadev's blessings." },
