  ...
  return (
    ...
    >
      ...
      <div className="puja-list-image">
        <img src={imageUrl} alt={puja.name} />
      ...
      <div className="puja-list-body">
        ...
        <p>{puja.short_description || puja.description}</p>

        {/* Footer */}
        <div className="puja-list-footer">
          <span className="puja-list-duration">
            <FiClock size={13} />
            {puja.duration || "N/A"} Hours
          </span>

          <Link to={pujaDetailsPath(detailId)} className="puja-list-link">
            View Details
