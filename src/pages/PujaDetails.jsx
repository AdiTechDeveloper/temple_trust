...
export default function PujaDetails() {
    ...
    const gallery = Array.isArray(puja.gallery)
        ? puja.gallery
        : [];


    const benefits = Array.isArray(puja.benefits)
        ? puja.benefits
        : [];


    const samagri = Array.isArray(puja.samagri)
        ? puja.samagri
        : [];
        ...
        <>
            ...
            <div className="puja-breadcrumb">
                ...
                <div className="container-xl">
                    ...
                    <Link to={ROUTE_PATHS.PUJA_BOOKING}>
                        Puja Booking
                    </Link>
